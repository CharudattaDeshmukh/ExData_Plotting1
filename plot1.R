...
setwd("R:/Data Science Specialization/Exploratory Data Analysis/ExData_Plotting1")
## Reading the txt File 
power <- read.csv("household_power_consumption.txt", header=T, sep=';', na.strings="?",nrows=2075260, check.names=F, stringsAsFactors=F, comment.char="", quote='\"')
...
rm(power)##Coercing the Global Active power variable to numeric
